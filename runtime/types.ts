...
export const PieceSchema = z.object({
	...
	/** Surviving critic / adversarial findings still open on this piece. */
	openFindings: z.array(z.string()).optional(),
	/** Independent adversarial second opinion passed (risky pieces). */
	adversarialPassed: z.boolean().optional(),
});
...
export const VerdictSchema = z.object({
	...
	/** criterion → evidence map when checklist critic used */
	criteriaMap: z
		.array(
			z.object({
				criterion: z.string(),
...
export const RunMetaSchema = z.object({
	...
	/** Piece ids/names that require adversarial second opinion after blind win. */
	riskyPieces: z.array(z.string()).optional(),
	/** Honesty gaps from plan/compose (≤3). */
	planGaps: z.array(z.string()).optional(),
	/** Final integrated-whole smoothing critic result. */
	smoothingPassed: z.boolean().optional(),
	smoothingGap: z.string().nullable().optional(),
